...
<head>
	...
	<title>Automatic Bill Payment</title>
	<style>
	@import
...
<div class="container-fluid">
	...
	<div class="col-md-6">
		<p style="padding-top:10px"><span class="caret"></span> Setting Up Automatic Bill Payment</p>
		<div style="background-color:white;border-top:solid;border-color:#117ACA">
			<form>
				<div class="form-group">
					<label for="text" class="col-2 col-form-label" style="font-size:15px">&nbsp;Payee's Name</label>
  					<div class="col-10">
    					<input class="form-control" type="text" id="AutoBillerName" style="margin-left:5px;width:98%">
  					</div>
  					<br>
  					<label for="text" class="col-2 col-form-label" style="font-size:15px">
  					&nbsp;Payee's Account Number/Credit Card Number</label>
  					<div class="col-10">
    					<input class="form-control" type="text" id="AutoBillAccount" style="margin-left:5px;width:98%">
  					</div>
  					<br>
  					<label for="text" class="col-2 col-form-label" style="font-size:15px">&nbsp;Payee's Bank Name</label>
  					<div class="col-10">
    					<input class="form-control" type="text" id="AutoBillerBankName" style="margin-left:5px;width:98%">
  					</div>
  					<br>
  					<label for="text" class="col-2 col-form-label" style="font-size:15px">&nbsp;Payee's Bank Branch Address</label>
  					<div class="col-10">
    					<input class="form-control" type="text" id="AutoBillerBankAdd" style="margin-left:5px;width:98%">
  					</div>
  					<br>
					...
					<br>
					<label for="text" style="font-size:15px;">&nbsp;Payment Amount (in $USD, All payments are in the same amount.)</label>
					<input type="number" class="form-control" style="margin-left:5px;width:98%"/>
					<br>
					<label for="name" style="font-size:15px;">&nbsp;First Payment Date</label>
					<input type="date" class="form-control" style="margin-left:5px;width:98%"/>
					<br>
					<label for="text" style="font-size:15px;">&nbsp;Payment Frequency</label>
					<select class="form-control" style="margin-left:5px;width:98%">
					...
					<br>
					<legend style="font-size:15px;">&nbsp;<b>Send Payments Until</b></legend>
    					<div class="form-check" style="margin-top:-2%;margin-left:5px;width:98%">
      					<label class="form-check-label">
        					<input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios1" value="option1" checked>
        					I change or cancel this payment.
      					</label>
    					</div>
    					<div class="form-check" style="margin-left:5px;width:98%">
    						<label class="form-check-label">
        					<input type="radio" class="form-check-input" name="optionsRadios" id="optionsRadios2" value="option2">
        					A total of <input type="number" class="form-control" style="width:20%;display:inline-block"/> payments are sent.
      					</label>
    					</div>
    					<div class="form-check" style="margin-left:5px;width:98%">
    						<label class="form-check-label">
        					...
        					A specified date:
        					<input type="date" class="form-control" style="width:55%;display:inline-block"/>
      					</label>
   					</div>
					<br>
					<button class="btn btn-info" type="button" style="margin-left:10px;margin-right:10px;float:right;"
					onclick = "window.location.href = 'ReviewAutomaticBill.jsp'">Next Step</button>
	...
	<div class="col-md-3">
	<p style="padding-top:10px;"><span class="caret"></span> Quick Access to Your Frequent Billers</p>
		<div style="background-color:white;border-top:solid;border-color:#117ACA">
			<br>
