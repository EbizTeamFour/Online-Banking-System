...
<div class="container-fluid">
	...
	<div class="col-md-6">
		<p style="padding-top:10px"><span class="caret"></span> Updaing Payee Information</p>
		<div style="width:650px;background-color:white;border-top:solid;border-color:#117ACA">
			<form>
				<div class="form-group">
					...
					&nbsp;Payee's Name</label>
  					<div class="col-10">
    					<input class="form-control" type="text" value="ABC Light Limited" style="margin-left:5px;width:98%">
  					</div>
  					<br>
  					<label for="text" class="col-2 col-form-label" style="font-size:15px">
  					&nbsp;Payee's Account Number/Credit Card Number</label>
  					<div class="col-10">
    					<input class="form-control" type="text" value="4567 7896 8932 7893" style="margin-left:5px;width:98%">
  					</div>
  					<br>
  					<label for="text" class="col-2 col-form-label" style="font-size:15px">
  					&nbsp;Payee's Bank Name</label>
  					<div class="col-10">
    					<input class="form-control" type="text" value="PNC Bank" style="margin-left:5px;width:98%">
  					</div>
  					<br>
  					<label for="text" class="col-2 col-form-label" style="font-size:15px">
  					&nbsp;Payee's Bank Branch Address</label>
  					<div class="col-10">
    					<input class="form-control" type="text" value="5000 Forbes Ave" style="margin-left:5px;width:98%">
  					</div>
  					<br>
					<button class="btn btn-info" type="button" style="margin-left:10px;margin-right:10px;float:right;">
					Update Payee</button>
					<button class="btn btn-default" type="button" style="float:right;">Delete Payee</button>
					<br>
					<br>
				</div>
			</form>
