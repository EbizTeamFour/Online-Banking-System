...
<div class="container-fluid">
	...
	<div class="col-md-9">
		<div style="height:250px;width:800px;background-color:white;border-top:solid;border-color:#117ACA;margin-top:4%">
			<br>
			<p style="text-align: left;font-size:15px;">&nbsp;Please Choose Your Type of Bill Payment:</p>
			<br>
			<div class="list-group">
  				<a href='RegularBill.jsp' class="list-group-item list-group-item-action" style="margin-left:5px;width:95%">
  				Pay Utility & Rent</a>
  				<a href='CreditCardBill.jsp' class="list-group-item list-group-item-action" style="margin-left:5px;width:95%">
  				Pay Credit Card Bill</a>
  				<a href='AutomaticBill.jsp' class="list-group-item list-group-item-action" style="margin-left:5px;width:95%">
  				Set Up Automatic Bill Payment</a>
			</div>
		</div>
	</div>
</div>
