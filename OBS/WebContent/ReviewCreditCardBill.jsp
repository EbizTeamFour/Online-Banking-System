...
<head>
	...
	<title>Review Credit Card Bill Payment</title>
	<style>
	@import
...
<div class="container-fluid">
	...
	<div class="col-md-9">
		<p style="padding-top:10px"><span class="caret"></span> Review Credit Card Bill Payment</p>
		<div style="width:800px;background-color:white;border-top:solid;border-color:#117ACA">
			<form>
				<div class="form-group">
					<label for="name" style="font-size:16px;padding-top:10px">&nbsp;Credit Card Number:</label>
					<span style="padding-left:2%">XXXX XXXX XXXX 4444</span>
					<a href="#" style="padding-left:2%">Edit</a>
					<br>
					<label for="name" style="font-size:16px;padding-top:10px">&nbsp;Name on Card:</label>
					<span style="padding-left:2%">John Doe</span>
					<a href="#" style="padding-left:2%">Edit</a>
					<br>
					...
					<a href="#" style="padding-left:2%">Edit</a>
					<br>
					<label for="name" style="font-size:16px;padding-top:10px">&nbsp;Payment Amount:</label>
					<span style="padding-left:2%">$1,432</span>
					<a href="#" style="padding-left:2%">Edit</a>
					<br>
					<label for="name" style="font-size:16px;padding-top:10px">&nbsp;Scheduled Payment Date:</label>
					<span style="padding-left:2%">11/15/2017</span>
					<a href="#" style="padding-left:2%">Edit</a>
					<br>
					...
					onclick = "window.location.href = 'CreditCardBill.jsp'">Back</button>
					<br>
					<br>
				</div>
			</form>
