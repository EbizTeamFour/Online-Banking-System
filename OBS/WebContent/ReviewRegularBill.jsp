...
<head>
	...
	<title>Review Regular Bill Payment</title>
	<style>
	@import
...
<div class="container-fluid">
	...
	<div class="col-md-9">
		<p style="padding-top:10px"><span class="caret"></span> Review Bill Payment</p>
		<div style="width:800px;background-color:white;border-top:solid;border-color:#117ACA">
			<form>
				<div class="form-group">
					<label for="name" style="font-size:16px;padding-top:10px">&nbsp;Biller Name:</label>
					<span style="padding-left:2%">Amberson Apartment</span>
					<a href="#" style="padding-left:2%">Edit</a>
					<br>
					<label for="name" style="font-size:16px;padding-top:10px">&nbsp;Biller's Account Number:</label>
					...
					onclick = "window.location.href = 'RegularBill.jsp'">Back</button>
					<br>
					<br>
				</div>
			</form>
